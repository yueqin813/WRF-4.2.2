...
!
!=================================Make Executable============================
!  Make executable:       updated 6/27/18
!
!    ifort   
...
! prevent the overwriting of a variable by mistake
  ...
  elseif (var == 'SMOIS') then
          data_real = data_real - 0.14   ! decrease soil moisture by 0.14
  elseif (var == 'TSLB') then
          data_real = data_real - 4  ! decrease soil temperature by 4
  else
